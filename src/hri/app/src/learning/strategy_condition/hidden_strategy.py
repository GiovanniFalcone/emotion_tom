...
class HiddenStrategy(AgentStrategy):
    def __init__(self, env):
        ...
        self.sentence_generator_second_flip = SuggestionGenerator(Util.get_experimental_condition(constants.HIDDEN_DECEPTION), language)
    ...
    def generate_sentence(self, hint_type, flip_type, flag_ToM, card, position):
        ...
        if is_first_flip:
            # Use ToM sentences if hint is provided for the first flip and mode is 'hidden'
